    ...
    <div className="min-h-screen flex items-center justify-center">
      <Card style={{ width: '600px' }} className="w-full max-w-md">
        ...
        >
          ...
          >
            <div>
              <span className="text-gray-700 font-semibold mb-1 block">Email Address</span>
              <Input
          ...
          <div className="text-center">
            <a href="/login" className="text-orange-400 hover:text-orange-600">Back to Login</a>
          </div>
        </Form>
      </Card>
    </div>
